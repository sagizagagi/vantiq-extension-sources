...
public class TestCSVReader extends TestCSVBase {
    ...
    public void testReadSimpleFile1Record() {
        ...
        ArrayList<Map<String, String>> content = CSVReader.execute(testFullFilePath, "default", config, null);
        ...
        assertTrue("Unexpected field flag in first of line of csv file in array",
                content.get(0).get("flag").equals("2"));
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                content.get(0).get("YScale").equals("1"));
    }
    ...
    public void testToManyEventsForSingleSegment() {
        ...
        ArrayList<Map<String, String>> lastSegment = CSVReader.execute(testFullFilePath, "default", config, null);
        ...
        assertTrue("Unexpected field flag in first of line of csv file in array",
                lastSegment.get(0).get("flag").equals("211"));
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                lastSegment.get(0).get("YScale").equals("111"));
        ...
        assertTrue("Unexpected field value in first of line of csv file in array",
                firstSegmentLines.get(0).get("value").equals("s"));
        assertTrue("Unexpected field flag in first of line of csv file in array",
                firstSegmentLines.get(0).get("flag").equals("2"));
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                firstSegmentLines.get(0).get("YScale").equals("1"));
    }
    ...
    public void testNotEnoughFieldsInSchema() {
        ...
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                content.get(0).get("YScale").equals("1"));
        assertTrue("Unexpected field field3 in first of line of csv file in array",
                content.get(0).get("field3").equals("3"));
    }
    ...
    public void testFredTest() {
        ...
        assertTrue("Unexpected field value in first of line of csv file in array",
                content.get(0).get("value").equals("fred"));
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                content.get(0).get("YScale").equals("namir"));
        assertTrue("Unexpected field flag in first of line of csv file in array",
                content.get(0).get("flag").equals("marty"));
    }
    ...
    public void testnoSkipNullValuesWithCommaDelimiter() {
        ...
        assertTrue("Unexpected field value in first of line of csv file in array",
                content.get(0).get("value").equals("s1"));
        assertTrue("Unexpected field flag in first of line of csv file in array",
                content.get(0).get("flag").equals("s3"));
    }
    ...
    public void testSkipNullValuesWithCommaDelimiter() {
        ...
        assertTrue("Unexpected field value in first of line of csv file in array",
                content.get(0).get("value").equals("s1"));
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                content.get(0).get("YScale").equals("s3"));
    }
    ...
    public void testProcessedNullValues() {
        ...
        assertTrue("Unexpected field value in first of line of csv file in array",
                content.get(0).get("value").equals("fred"));
        assertTrue("Unexpected field YScale in first of line of csv file in array",
                content.get(0).get("field5").equals("namir"));
        assertTrue("Unexpected field flag in first of line of csv file in array",
                content.get(0).get("field7").equals("marty"));
    }
