 ...
 * the same VANTIQ Server & Namespace (i.e. same authtoken). Options are in a
 * file where each option has its own line,
...
public class JDBCMain {
    ...
    public static void main(String[] args) {
        Properties config;
        log.error(String.format("Start V%s", JDBC.JDBC_VERSION));
